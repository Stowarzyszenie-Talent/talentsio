...
RAW_COMMANDS = [
    ...
    ("run", "Run django server and webpack", 
     '{exec} web conc -n js,py -c yellow,green -k "npm --prefix ../oioioi run -s watch" "python3 manage.py runserver --insecure 0.0.0.0:8000"'),
    ...
    # Flaky.
    ("test-paralell", "Run unit tests in paralell.", "{exec} web ../oioioi/test.sh -n auto --dist=loadscope {extra_args}"),
